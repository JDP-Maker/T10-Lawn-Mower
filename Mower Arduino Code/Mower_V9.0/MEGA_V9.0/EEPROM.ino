...
message_out.println("*** EEPROM Settings ***");
  ...
  if (Alarm_2_Saved_EEPROM == 1) {
    ...
    message_out.print(F("Alarm 2 time from EEPROM "));
    ...
    if (Alarm_2_ON == 1) message_out.println(" | Alarm 2 Active");
  ...
  if (Alarm_3_Saved_EEPROM == 1) {
    ...
    message_out.print(F("Alarm 3 time from EEPROM "));
    ...
    if (Alarm_3_ON == 1) message_out.println(" | Alarm 3 Active");
  ...
  if (PWM_LEFT_EEPROM == 1) {
    ...
    message_out.print(F("PWM Wheel Left value from EEPROM : "));
  ...
  if (PWM_RIGHT_EEPROM == 1) {
    ...
    message_out.print(F("PWM Wheel Right value from EEPROM : ")); 
  ...
  if (PWM_LEFT_Slow_EEPROM == 1) {
    ...
    message_out.print(F("PWM Wheel Wire Left value from EEPROM : "));
  ...
  if (PWM_RIGHT_Slow_EEPROM == 1) {
    ...
    message_out.print(F("PWM Wheel Wire Right value from EEPROM : ")); 
  ...
  if (Slow_Speed_MAG_EEPROM == 1) {
    ...
    message_out.print(F("Slow Speed MAG from EEPROM : ")); 
  ...
  if (PWM_BLADE_EEPROM == 1) {
    ...
    message_out.print(F("PWM Blade value from EEPROM : ")); 
  ...
  if (COMPASS_EEPROM == 1) {
    ...
    message_out.print(F("Compass Activated from EEPROM : "));
  ...
  if (COMPASS_Setup_Mode_EEPROM == 1) {
    ...
    message_out.print(F("Compass Setup Mode from EEPROM : "));
  ...
  if (Compass_Heading_Hold_Enabled_EEPROM == 1) {
    ...
    message_out.print(F("Compass HEading Hold Settings from EEPROM : "));
  ...
  if (CPower_EEPROM == 1) {
    ...
    CPower = CPower / 10; 
    message_out.print(F("Compass Power from EEPROM : "));
 ...
 int Tracking_PID_P_EEPROM = EEPROM.read(21);
  if (Tracking_PID_P_EEPROM == 1) {
    P = EEPROM.read(22); 
    P = P / 100; 
    message_out.print(F("Traking PID P Setting from EEPROM : "));
  ...
  if (Pattern_Mow_EEPROM == 1) {
    ...
    //Pattern_Mow = 1;
    message_out.print(F("Pattern Mow settings from EEPROM : "));
    if (Pattern_Mow == 0) message_out.println(F("OFF"));
    if (Pattern_Mow == 1) message_out.println(F("ON Parallel"));
    if (Pattern_Mow == 3) message_out.println(F("ON Spiral"));
  }
  ...
  if (Minimum_Volt_EEPROM == 1) {
    ...
    message_out.print(F("Minimum Battery Voltage set from EEPROM : "));
  ...
  if (Angle_Sensor_Enabled_EEPROM == 1) {
    ...
    message_out.print(F("Angle Sensor Enabled from EEPROM : "));
  ...
  if (Tip_Over_Sensor_Enabled_EEPROM == 1) {
    ...
    message_out.print(F("Tip Sensor Enabled from EEPROM :  "));
  ...
  if (Mower_Turn_Delay_Min_EEPROM == 1) {
    ...
    message_out.print(F("Mower Turn Delay Min From EEPROM : "));
  ...
  if (Mower_Turn_Delay_Max_EEPROM == 1) {
    ...
    message_out.print(F("Mower Turn Delay Max From EEPROM : "));
  ...
  if (Mower_Reverse_Delay_EEPROM == 1) {
    ...
    message_out.print(F("Mower Reverse Time Delay/ms: "));
  ...
  if (Sonar_1_Activate_EEPROM == 1) {
    ...
    message_out.print(F("Sonar 1 Activated: "));
  ...
  if (Sonar_2_Activate_EEPROM == 1) {
    ...
    message_out.print(F("Sonar 2 Activated: "));
  ...
  if (Sonar_3_Activate_EEPROM == 1) {
    ...
    message_out.print(F("Sonar 3 Activated: "));
    message_out.println(Sonar_3_Activate);
  }
  
  int Sonar_4_Activate_EEPROM = EEPROM.read(137);
  if (Sonar_4_Activate_EEPROM == 1) {
    Sonar_4_Activate = EEPROM.read(138);
    message_out.print(F("Sonar 4 Activated: "));
    message_out.println(Sonar_4_Activate);
  }

  int Sonar_5_Activate_EEPROM = EEPROM.read(139);
  if (Sonar_5_Activate_EEPROM == 1) {
    Sonar_5_Activate = EEPROM.read(140);
    message_out.print(F("Sonar 5 Activated: "));
    message_out.println(Sonar_5_Activate);
  }
  
    int Sonar_6_Activate_EEPROM = EEPROM.read(141);
  if (Sonar_6_Activate_EEPROM == 1) {
    Sonar_6_Activate = EEPROM.read(142);
    message_out.print(F("Sonar 6 Activated: "));
    message_out.println(Sonar_6_Activate);
  }
  ...
  if (Track_Wire_Zone_1_Cycles_EEPROM == 1) {
    ...
    message_out.print(F("Zone 1 Tracking Cycles "));
  ...
  if (Track_Wire_Zone_2_Cycles_EEPROM == 1) {
    ...
    message_out.print(F("Zone 2 Tracking Cycles "));
  ...
  if (Use_Charging_Station_EEPROM == 1) {
    ...
    message_out.print(F("Charge Station from EEPROM : "));
  ...
  if (CW_Tracking_To_Charge_EEPROM == 1) {
    ...
    message_out.print(F("Tracking Direction to Charge : "));
  ...
  if (CW_Tracking_To_Start_EEPROM == 1) {
    ...
    message_out.print(F("Tracking Direction to Start : "));
  ...
  if (Max_Cycles_Straight_EEPROM == 1) {
    ...
    message_out.print(F("Straight Line Cycles before turn: "));
  ...
  if (Max_Sonar_Hit_EEPROM == 1) {
    ...
    message_out.print(F("Sonar Sensitivoty from EEPROM : "));
  ...
  if (maxdistancesonar_EEPROM == 1) {
    ...
    message_out.print(F("Sonar Activation Distance from EEPROM : "));
  ...
  if (Perimeter_Wire_Enabled_EEPROM == 1) {
    ...
    message_out.print(F("Wire Module ON/OFF from EEPROM : "));
  ...
  if (Max_Cycle_Wire_Find_EEPROM == 1) {
    ...
    message_out.print(F("Track Cycles Forwards to find Wire "));
  ...
  if (Max_Cycle_Wire_Find_Back_EEPROM == 1) {
    ...
    message_out.print(F("Track Cycles Back to find Wire "));
  ...
  if (Max_Tracking_Turn_Right_EEPROM == 1) {
    ...
    message_out.print(F("Wheel RH Cycles before restart "));
  ...
  if (Max_Tracking_Turn_Left_EEPROM == 1) {
    ...
    message_out.print(F("Wheel LH Cycles before restart "));
  ...
  if (Rain_Sensor_Installed_EEPROM == 1) {
    ...
    message_out.print(F("Rain Sensor ON/OFF from EEPROM : "));
  ...
  if (Rain_Total_Hits_Go_Home_EEPROM == 1) {
    ...
    message_out.print(F("Rain Sensitivoty from EEPROM : "));
  ...
  if (WIFI_Enabled_EEPROM == 1) {
    ...
    message_out.print(F("WIFI Enabled from EEPROM : "));
  ...
  if (Cutting_Blades_Activate_EEPROM == 1) {
    ...
    message_out.print(F("CUTTING BLADES SET TO : "));
  ...
  if (Low_Battery_Instances_Chg_EEPROM == 1) {
    ...
    message_out.print(F("Battery to Charge Sensitivoty from EEPROM : "));
  ...
  if (Bumper_Activate_Frnt_EEPROM == 1) {
    ...
    message_out.print(F("Bumper Bar Enabled from EEPROM : "));
  ...
  if (Turn_90_Delay_LH_EEPROM == 1) {
    ...
    message_out.print(F("Turn_90_Delay_LH Enabled from EEPROM : "));
  ...
  if (Turn_90_Delay_RH_EEPROM == 1) {
    ...
    message_out.print(F("Turn_90_Delay_RH Enabled from EEPROM : "));
  ...
  if (Line_Length_Cycles_EEPROM == 1) {
    ...
    message_out.print(F("Line_Length_Cycles Enabled from EEPROM : "));
  ...
  if (GPS_Enabled_EEPROM == 1) {
    ...
    message_out.print(F("GPS Enabled from EEPROM : "));
  ...
  if (GYRO_Enabled_EEPROM == 1) {
    ...
    message_out.print(F("GYRO Enabled from EEPROM : "));
  ...
  if (GPower_EEPROM == 1) {
    ...
    GPower = GPower / 10; 
    message_out.print(F("GYRO PID set from EEPROM : "));
  ...
  if (Wheel_Amp_Sensor_ON_Enabled_EEPROM == 1) {
    ...
    message_out.print(F("Wheel Block Amp Sensor Enabled from EEPROM : "));
  ...
  if (Max_Wheel_Amps_EEPROM == 1) {
    ...
    message_out.print(F("Wheel Block Amps set from EEPROM : "));
  ...
  if (PCB_EEPROM == 1) {
    PCB = EEPROM.read(120); 
    message_out.print(F("PCB Enabled from EEPROM : "));
...
void Clear_EERPOM() {
  ...
  EEPROM.write(137,0);     // Clear Sonar 4
  EEPROM.write(139,0);     // Clear Sonar 5
  EEPROM.write(141,0);     // Clear Sonar 6 
